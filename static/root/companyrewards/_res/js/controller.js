var app = angular.module('rewardsModule', [{
    files: ['root/companyrewards/_res/js/service.js']
}]);
app.controller('rewardsCtrl', function ($scope,$state) {
    if ($state.current.url == '/companyrewards') {//默认加载列表
        $state.go('root.companyrewards.bonusbudget');
    }
    ...
    $scope.navCla='bonusbudget';
    var active = $location.path().split('/')[3];
    $scope.navCla=active?active:'bonusbudget';
    ...
    $scope.showsList = [
        {id:"1",item:"公司奖励",menuList:[{name:'公司奖励',msg:'bonusbudget'},{name2:"奖励人数统计",msg:'peoplenostat'},{name3:"奖品申请",msg:'prizeapply'},{name4:"奖励指标模板",msg:'indicator'}],showIs:false},
